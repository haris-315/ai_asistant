...
class FunctionDefinitionProvider(private val client: OpenAIClient) {
            ...
            listOf(
                    object : FunctionDefinition {
                        ...
                        override val description =
                                "Retrieve the email report summary for a specified day from the database."
                                            ...
                                            JSONObject().apply {
                                                put(
                                                        ...
                                                        JSONObject().apply {
                                                            ...
                                                            put(
                                                                    "description",
                                                                    "The date to retrieve the email report for, in YYYY-MM-DD format"
                                                            )
                                                        }
                                                )
                                            }
                        ...
                        override fun execute(args: JSONObject): JSONObject {
                            ...
                            try {
                                ...
                                if (response == null) {
                                    ...
                                    result.put(
                                            "Error",
                                            "There was and error while looking for the emails report."
                                    )
                                    return result
                                }
                                ...
                                result.put(
                                        "Success",
                                        "Report of emails recived on $day: ${response.joinToString("\n")}"
                                )
                                return result
                            } catch (e: Exception) {
                                Log.e(
                                        "OpenAIClient",
                                        "Error processing get_email_report_by_day: ${e.message}"
                                )
                                result.put(
                                        "error",
                                        "Error processing get_email_report_by_day: ${e.message}"
                    ...
                    object : FunctionDefinition {
                        ...
                        override val description =
                                "Fetch current weather details for a specified location using the MET Norwegian Weather API."
                        override val parameters =
                                JSONObject().apply {
                                    put("type", "object")
                                    put(
                                            ...
                                            JSONObject().apply {
                                                put(
                                                        ...
                                                        JSONObject().apply {
                                                            ...
                                                            put(
                                                                    "description",
                                                                    "The name of the location (e.g., city, town) to fetch weather for"
                                                            )
                                                        }
                                                )
                                            }
                    ...
                    object : FunctionDefinition {
                        ...
                        override val description =
                                "Initiate a phone call to a contact by name. If multiple contacts match, return their details for disambiguation."
                        override val parameters =
                                JSONObject().apply {
                                    put("type", "object")
                                    put(
                                            ...
                                            JSONObject().apply {
                                                ...
                                                put(
                                                        ...
                                                        JSONObject().apply {
                                                            ...
                                                            put(
                                                                    "description",
                                                                    "The unique ID of the contact (used for disambiguation when provided)"
                                                            )
                                                        }
                                                )
                                            }
                                            ...
                                            JSONObject().apply {
                                                ...
                                                put(
                                                        ...
                                                        JSONObject().apply {
                                                            ...
                                                            put(
                                                                    "description",
                                                                    "Project ID (use id of the project named Inbox if no project is specified or the specified project is not available)"
                                                            )
                                                        }
                                                )
                                                put(
                                                        ...
                                                        JSONObject().apply {
                                                            ...
                                                            put(
                                                                    "description",
                                                                    "Timestamp in ISO-8601 format using UTC (ends with 'Z'), e.g., 2025-06-12T06:54:29.105Z. This ensures consistent time globally across devices and platforms. Optional."
                                                            )
                                                        }
                                                )
                                                put(
                                            ...
                                            JSONObject().apply {
                                                put(
                                                        ...
                                                        JSONObject().apply {
                                                            ...
                                                            put(
                                                                    "description",
                                                                    "App package name (e.g., com.google.android.youtube)"
                                                            )
                                                        }
                                                )
                                                put(
                    ...
                    object : FunctionDefinition {
                        ...
                        override val description =
                                "Collect and store user data from prompts for personalized responses, up to 24 points."
                        override val parameters =
                                JSONObject().apply {
                                    put("type", "object")
                                    put(
                                                        ...
                                                        JSONObject().apply {
                                                            ...
                                                            put(
                                                                    ...
                                                                    JSONObject().apply {
                                                                        ...
                                                                        put(
                                                                                "description",
                                                                                "A concise data point (e.g., 'Name is John', 'Prefers dark mode')"
                                                                        )
                                                                    }
                                                            )
                                                            put(
    ...
    fun executeFunction(name: String, args: JSONObject): JSONObject {
        ...
        return functionDef?.execute(args)
                ?: JSONObject().apply { put("error", "Unknown function: $name") }
    }
    ...
    private fun getWeather(args: JSONObject): JSONObject {
        ...
        try {
            ...
            if (addresses.isEmpty()) {
                ...
                return JSONObject().apply {
                    put("error", "No coordinates found for location: $locationName")
                }
            }
            ...
            val request =
                    Request.Builder()
                            ...
                            .addHeader(
                                    "User-Agent",
                                    "OpenAIClient/1.0 (contact: your-email@example.com)"
                            )
                            .build()

            NetworkHelper(client.client, client.apiKey, client.authToken)
                    .executeWithRetry(
                            request = request,
                            onSuccess = { response ->
                                try {
                                    if (response.isSuccessful) {
                                        ...
                                        val current =
                                                timeseries.getJSONObject(0).getJSONObject("data")
                                        val instant =
                                                current.getJSONObject("instant")
                                                        .getJSONObject("details")
                                        val temperature = instant.getDouble("air_temperature")
                                        val condition =
                                                current.getJSONObject("next_1_hours")
                                        ...
                                        Log.d(
                                                "OpenAIClient",
                                                "Weather fetched for $locationName: $temperature°C, $condition"
                                        )
                                    } else {
                                        val errorBody = response.body?.string() ?: "Unknown error"
                                        Log.w(
                                                "OpenAIClient",
                                                "Weather fetch failed: ${response.code}, $errorBody"
                                        )
                                        result.put(
                                                "error",
                                                "Weather fetch failed: HTTP ${response.code}, $errorBody"
                                        )
                                    }
                                } catch (e: Exception) {
                                    Log.e(
                                            "OpenAIClient",
                                            "Error processing weather response: ${e.message}"
                                    )
                                    result.put(
                                            "error",
                                            "Error processing weather response: ${e.message}"
        ...
        try {
            ...
            when {
                ...
                contacts.size > 1 && !args.has("contact_id") -> {
                    ...
                    Log.d(
                            "OpenAIClient",
                            "Initiated call to: ${contact.getString("display_name")} ($phoneNumber)"
                    )
                    result.put("status", "success")
    ...
    private fun createTask(args: JSONObject): JSONObject {
        val result = JSONObject()
        Log.d("Reminder:", args.getString("reminder_at"))
        try {
            val taskBody =
                    JSONObject().apply {
                        ...
                        if (args.has("reminder_at"))
                                put("reminder_at", args.getString("reminder_at"))
                    }
                                    ...
                                    if (response.isSuccessful) {
                                        ...
                                        val taskMap =
                                                mutableMapOf<String, Any>().apply {
                                                    ...
                                                    put(
                                                            "description",
                                                            taskBody.getString("description")
                                                    )
                                                    put(
                                                            "is_completed",
                                                            taskBody.getBoolean("is_completed")
                                                    )
                                                    put("priority", taskBody.getInt("priority"))
                                                    put("project_id", taskBody.getInt("project_id"))
                                                    if (taskBody.has("due_date"))
                                                            put(
                                                                    "due_date",
                                                                    taskBody.getString("due_date")
                                                            )
                                                    if (taskBody.has("reminder_at"))
                                                            put(
                                                                    "reminder_at",
                                                                    taskBody.getString(
                                                                            "reminder_at"
                                        ...
                                        SharedData.tasks =
                                                SharedData.tasks.toMutableList().apply {
                                                    add(taskMap)
                                                }
                                        ...
                                        Log.w(
                                                "OpenAIClient",
                                                "Task creation failed: ${response.code}, $errorBody"
                                        )
                                        result.put(
                                                "error",
                                                "Task creation failed: HTTP ${response.code}, $errorBody"
                                        )
                                    }
                                } catch (e: Exception) {
                                    Log.e(
                            ...
                            onSuccess = { response ->
                                try {
                                    if (response.isSuccessful) {
                                        ...
                                        Log.w(
                                                "OpenAIClient",
                                                "Task update failed: ${response.code}, $errorBody"
                                        )
                                        result.put(
                                                "error",
                                                "Task update failed: HTTP ${response.code}, $errorBody"
                                        )
                                    }
                                } catch (e: Exception) {
                                    Log.e(
                                            "OpenAIClient",
                                            "Error processing task update: ${e.message}"
                                    )
                                    result.put(
                                            "error",
                                            "Error processing task update: ${e.message}"
                            ...
                            onSuccess = { response ->
                                try {
                                    if (response.isSuccessful) {
                                        ...
                                        Log.w(
                                                "OpenAIClient",
                                                "Project creation failed: ${response.code}, $errorBody"
                                        )
                                        result.put(
                                                "error",
                                                "Project creation failed: HTTP ${response.code}, $errorBody"
                                        )
                                    }
                                } catch (e: Exception) {
                                    Log.e(
                                            "OpenAIClient",
                                            "Error processing project creation: ${e.message}"
                                    )
                                    result.put(
                                            "error",
                                            "Error processing project creation: ${e.message}"
